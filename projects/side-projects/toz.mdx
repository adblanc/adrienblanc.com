...
It is availaible on both the _[App Store](https://apps.apple.com/fr/app/toz-jeux-dalcool-en-soir%C3%A9e/id1476978964#?platform=iphone)_ and _[Google Play store](https://play.google.com/store/apps/details?id=com.blincio.toz&hl=fr&gl=US)_ and has over **200K downloads 🥳**.
