...
We had to build a [Single Page Application](https://en.wikipedia.org/wiki/Singlepage_application) using [Ruby on Rails (RoR)](https://rubyonrails.org/), [Backbone.JS](https://backbonejs.org/) and [PostgreSQL](https://www.postgresql.org/). <br />
Users should be able to play the famous [pong game](https://en.wikipedia.org/wiki/Pong), have friends, guilds, chat with each other, and a bunch more features.

### What I learned

#### Ruby on Rails

I had never written **ruby** nor used **Ruby on Rails** before and I loved it. <br />
It **boosted my productivity** a lot because their is no need to write boilerplate and it does a lot for me. <br />
...
Nevertheless, it increased my **web knowledge** a lot.
...
I implemented **OAuth authentication** with **42 API**, and like it a lot. <br />
The fact that you don't have to worry about storing the user password or even the create account logic is of great help.

#### Websockets

Ruby on Rails comes with a lovely library to handle websockets : **Action Cable**. <br />
It has a **nice API** and allowed me to add real time update on the website. <br />
I used it to build the **real time chat interface** but also for the **pong game** itself. <br />
